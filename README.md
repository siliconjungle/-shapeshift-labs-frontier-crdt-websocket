...
Latest local package benchmark on Node v26.1.0, darwin arm64, 31 rounds:

| Fixture | Median | p95 | Bytes |
| --- | ---: | ---: | ---: |
| WebSocket binary frame encode/decode | 2.01 us | 2.47 us | 165 |
| WebSocket JSON frame encode/decode | 0.70 us | 0.75 us | 247 |
| WebSocket client/server handshake | 303.34 us | 429.75 us | - |
| WebSocket two-peer CRDT sync | 692.37 us | 831.67 us | - |
